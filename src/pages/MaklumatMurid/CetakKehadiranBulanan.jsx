            ...
            <table className="w-full border-collapse text-[9px]">
              <thead>
                <tr>
                  ...
                  <th className="border border-black px-1 py-1 w-8">Jumlah Hadir</th>
              ...
              <tbody>
                {k.pelajar.map((p, idx) => (
                  <tr key={p.idMurid}>
                    ...
                    <td className="border border-black text-center px-0.5 py-0.5 font-bold">{p.jumlahHadirMurid}</td>
                    <td className="border border-black text-center px-0.5 py-0.5 font-bold">{p.peratus !== null ? `${p.peratus}%` : '-'}</td>
                  </tr>
                ))}
