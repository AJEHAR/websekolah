...
import { JAWATAN_OPTIONS, KATEGORI_OPTIONS, JENIS_PPM_OPTIONS } from './constants.js'
...
export default function ProfileForm({ profile, onSimpan, onBatal }) {
  ...
  async function hantar(e) {
    ...
    try {
      ...
      await onSimpan({ nama: nama.trim(), ic: ic.trim(), jawatan, kategori, jenisPPM: kategori === 'PPM' ? jenisPPM : null, gambarURL })
    } catch (err) {
