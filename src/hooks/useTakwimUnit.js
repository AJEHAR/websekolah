...
// 4 unit utama sekolah - AUTO-SEDIA sekali sahaja bila koleksi kosong
// (staff pertama buka Takwim, bukan perlu admin sediakan dulu secara
// manual). Admin boleh tambah unit/panitia lain lepas ni terus di page
// Takwim sendiri (bukan Panel Admin berasingan).
const UNIT_LALAI = [
  { namaUnit: 'Pentadbiran', warna: '#C8102E' },
  { namaUnit: 'Kurikulum', warna: '#2563EB' },
  { namaUnit: 'Hal Ehwal Murid', warna: '#16A34A' },
  { namaUnit: 'Kokurikulum', warna: '#F2C230' },
]
...
export async function tambahTakwimUnit(namaUnit, warna, uid) {
  if (!isFirebaseConfigured) throw new Error('Firebase belum disetup')
  await addDoc(collection(db, KOLEKSI), { namaUnit, warna, createdAt: serverTimestamp(), updatedBy: uid })
}
